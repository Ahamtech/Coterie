...
Container {
    ...
    property alias unread: imagepic.imageSource
    leftPadding: ui.du(1)
    rightPadding: ui.du(1)
    bottomPadding: ui.du(1.0)

    background: if( imageSource == "asset:///images/icons.png" ){Application.themeSupport.theme.colorTheme.style == 2 ? Color.create("#323232") : Color.create("#90c7dfe4")}
    Container {
        layout: StackLayout {
