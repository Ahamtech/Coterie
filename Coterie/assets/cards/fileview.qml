...
Page {
    ...
    function attfinish() {
        ...
        console.log(imageso.imageSource)
                                ...
                                listItemComponents: [
                                    ...
                                    ListItemComponent {
                                        ...
                                        CustomCommentList {
                                            ...
                                            title: Qt.getChannelById(ListItemData.user)
                                            status: Moment.moment.unix(ListItemData.timestamp).locale(Qt.local).format('LLL')
                                            imageSource: Qt.filePath + ListItemData.user + ".png"
            ...
            if (doc.readyState === XMLHttpRequest.DONE) {
                if (doc.status == 200) {
                    ...
                    if (info.ok == true) {
                        ...
                        username.text = Qt.getChannelById(info.file.user)
                        fileuploaduser.imageSource = Qt.filePath + info.file.user + ".png"
